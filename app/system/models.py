...
class LabOrder(Base):
    ...
    receiver_id: Mapped[int] = mapped_column('receiver_id', ForeignKey('users.id'), nullable=True)
    receiver: Mapped["User"] = relationship(foreign_keys=[receiver_id])
    customer: Mapped["Customer"] = relationship(back_populates="orders")
    approved_at: Mapped[datetime] = mapped_column('released_at', DateTime(), nullable=True)
